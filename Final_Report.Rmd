...
df_timedata <- read_csv("processed_data/avglaptime.csv")
...
- This data is for 70 years of races and many things have changed over that period
...
```{r finish race, fig.width=8, fig.height=6, echo=FALSE}
df_data %>% 
